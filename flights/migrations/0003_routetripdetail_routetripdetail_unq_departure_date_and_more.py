    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fare_type', models.CharField(choices=[('economy', 'Economy'), ('premium', 'Premium')], max_length=20)),
                ...
                ('route', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='trip_details', to='flights.route')),
            ],
            options={
                'ordering': ['created_at'],
                'abstract': False,
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('route', 'departure_date', 'fare_type', 'trip_type'), name='unq_departure_date'),
        ),
        migrations.AddConstraint(
            model_name='routetripdetail',
